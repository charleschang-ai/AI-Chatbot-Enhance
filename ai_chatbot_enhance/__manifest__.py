...
################################################################################
{
    'name': 'AI Chatbot Enhance | RAG & Vector Search | Odoo Query & Record Automation | AI RAG | AI Skills | AI Tools| AI Copilot | AI Assistant for Discuss | AI Studio | Odoo Studio',
    'version': '19.0.1.0.1',
